...
function AudioPlayer() {
  ...
  useEffect(() => {
    ...
    const volumeProgress = audioPlayer.querySelector('.slider .progress');
    ...
    volumeProgressRef.current = volumeProgress;
  ...
  const handleMouseDown = event => {
    ...
    setCurrentlyDragged(event.target);
  ...
  const togglePlay = () => {
    if (audioRef.current.paused) {
      playPauseRef.current.attributes.d.value = "M0 0h6v24H0zM12 0h6v24h-6";
      audioRef.current.play();
    } else {
      playPauseRef.current.attributes.d.value = "M18 12L0 24V0";
